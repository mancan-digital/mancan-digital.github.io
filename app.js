        const translations = {
            en: {
                ...
                'pr-soundlock-desc': 'One-time purchase, lifetime use of the purchased major version.',
                'pr-onetime': 'one-time',
                ...
                'tos-p2': 'Our software products (such as Cenna and SoundLock) are licensed, not sold. Subject to payment and these Terms, we grant you a non-exclusive, non-transferable license to install and use the purchased product for your own use. You may not resell, redistribute, sublicense, reverse-engineer, or remove proprietary notices from the software, except where such restriction is prohibited by law.',
            ...
            pt: {
                ...
                'pr-soundlock-desc': 'Compra única, uso vitalício da versão principal adquirida.',
